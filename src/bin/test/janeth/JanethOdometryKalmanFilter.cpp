...
/** \file JanethOdometryKalmanFilter.cpp
    \brief This file is a testing binary for the JanethOdometryKalmanFilter
           class.
  */
...
TEST(JanethOdometryCalibrationTestSuite, testAckermannOdometryKalmanFilter) {
  ...
  JanethOdometryKalmanFilter odometry(diffParams, ackParams, janethParams,
  ...
  ASSERT_EQ(odometry.getJanethKalmanFilterParameters(), janethKfParams);
  ASSERT_EQ(odometry.getDifferentialParameters(), diffParams);
  ASSERT_EQ(odometry.getAckermannParameters(), ackParams);
  ASSERT_EQ(odometry.getJanethParameters(), janethParams);
